...
def parse_args():
    ...
    parser.add_argument("--cem-momentum", type=float, default=0.1) # TODO: Try no
...
def make_env(env_id, control_mode, seed, video_dir=None, video_trigger=None):
    def thunk():
        env = gym.make(env_id, reward_mode='dense', obs_mode='rgbd', control_mode=control_mode, camera_cfgs=None)
...
if __name__ == "__main__":
    ...
    # env setup
    make_env(args.env_id, args.control_mode, args.seed+1)
